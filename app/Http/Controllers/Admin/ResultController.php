                    ...
                    foreach ($selectedElection->positions as $position) {
                        ...
                        if (strtolower(trim($position->name)) === 'representative') {
                            ...
                            foreach ($position->candidates as $candidate) {
                                $groupKey = $candidate->course . ' ' . $candidate->year_level;
                            ...
                            // Flatten for view: each group as a separate 'result' entry
                            foreach ($grouped as $groupKey => $group) {
                                $candidateResults = $group['candidates'];
                                $totalVotes = $group['total_votes'];
                                $abstainVotes = $group['abstain_votes'];
                            ...
                            // Skip adding the default (ungrouped) result for representative
                            continue;
                        } else {
                            foreach ($position->candidates as $candidate) {
