<x-admin-layout title="Create Party">
    <x-slot name="styles">
        <style>
            .form-section {
                background: white;
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2><i class="bi bi-flag"></i> Create New Party</h2>
                    ...
                    <form action="{{ route('admin.parties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <input type="color" 
                                       ...
                                       id="color" 
                                       name="color" 
                                       value="{{ old('color', '#003366') }}"
                                       required
                                       style="width: 80px; height: 50px;">
                                <div class="color-preview" id="colorPreview"></div>
                                <div>
                                    <small class="text-muted d-block">This color will be used for party branding</small>
                                    <small class="text-muted d-block">Selected: <strong id="colorValue">{{ old('color', '#003366') }}</strong></small>
                                </div>
                            </div>
                            @error('color')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Brief description of the party's platform and values...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Create Party
                            </button>
                            <a href="{{ route('admin.parties.index') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <div class="logo-preview-container mx-auto" id="previewLogo">
                                <i class="bi bi-flag-fill" style="font-size: 3rem; color: var(--aclc-blue);"></i>
                            </div>
                        </div>
                        <h4 id="previewName" class="mb-2">Party Name</h4>
                        <span class="badge mb-3" id="previewAcronym" style="background: #003366; color: white;">
                            ACRONYM
                        </span>
                        <p class="text-muted small" id="previewDescription">
                            Party description will appear here...
                        </p>
                    </div>
                </div>
            </div>
